...
class ChatRequest(BaseModel):
    ...
    pdf_text: str  # Add pdf_text field
...
def chat(request: ChatRequest):
    ...
    prompt = (f"You are an AI medical assistant specializing in {specialty}. "
              ...
              "3. A score allocated to these symptoms in terms of emergency to go to the doctor\n"
              "4. Suggested actions (e.g., suggest a doctor, book an appointment)\n"
              "\n"
    ...
    # Add PDF text for RAG (retrieval-augmented generation)
